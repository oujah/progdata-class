...
w1 <- waste |> 
  ggplot(mapping = aes(plastic_waste_per_cap)) +
...
waste|>
  ggplot(mapping = aes(x = plastic_waste_per_cap, 
                       color = continent,
                       fill = continent)) +
  geom_density(alpha = 0.4, aes(y = after_stat(count)*bw)) +
...
ggplot(waste) + 
  aes(x = plastic_waste_per_cap, 
      y = mismanaged_plastic_waste_per_cap, shape = factor(continent)) +
  geom_point(size = 2, color = "blue", fill = "yellow")  + 
  scale_x_continuous(name = "Plastic Waste per Capita") +
  scale_y_continuous(name = "Mismanaged Plastic Waste")  +
  theme_minimal()
...
ggplot(waste,
       aes(plastic_waste_per_cap, 
           y = mismanaged_plastic_waste_per_cap, color = continent, shape = continent)) +
  geom_point()+
...
ggplot(waste, 
  aes(x = plastic_waste_per_cap, 
      y = total_pop/10000000, 
      color = continent)) +
  geom_point() + 
  scale_x_continuous(name = "Plastic Waste per Capita") +
  scale_y_continuous(name = "Total Population in millions")


  ggplot(waste,
       aes(x = plastic_waste_per_cap, y = total_pop/10000000, 
      color = continent)) +
  geom_point() +
